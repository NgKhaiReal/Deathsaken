...
local scripturl = "https://api.junkie-development.de/api/v1/luascripts/public/5af96f694bc9dbef2eb9e51a7e81902dd5492438743effe612ba67abe08a350a/download"
...
if showGUI then
    ...
    Tabs.KeyTab:AddKeyBox("600MEMBERS", function(Success, ReceivedKey)
        if Success then
